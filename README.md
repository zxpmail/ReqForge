...
- **Prompt slimming (P0)**: `dev-builder` SKILL index-only (~36k→~7k chars); workflow/principles in `references/`; shared pointers in `core/skills/_shared/`; compressed `forge-bootstrap`
