...
| 5 | **Validation loop** | Tests, lint, or typecheck before “done” | `dev-builder` TDD, `pre-commit-check`, Sloppiness Gate in `CLAUDE.md`; framework repo: `pnpm forge-smoke` (9 smokes incl. workflows compliance) |
